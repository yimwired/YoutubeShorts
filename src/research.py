...
def pick_trend_topic(candidates: list[dict],
    ...
    prompt = (
        ...
        "   ถ้าคะแนนพอกัน ให้เลือกอันที่คนไทยเจอในชีวิตประจำวันอยู่แล้ว "
        "(ของกิน ของใช้ แบรนด์ สถานที่ คำที่พูดกันติดปาก) เหนืออันที่ต้องอธิบายว่าคืออะไรก่อน "
        "— คนดูต้องมีความเห็นเรื่องนั้นอยู่แล้วถึงจะคอมเมนต์\n"
